...
class MomentsControllerTest < ActionController::TestCase
  ...
  test "should create moment" do
    assert_difference('Moment.count') do
      post :create, moment: { content: @moment.content, content_type: @moment.content_type, type: @moment.type }
    end
  ...
  test "should update moment" do
    patch :update, id: @moment, moment: { content: @moment.content, content_type: @moment.content_type, type: @moment.type }
    assert_redirected_to moment_path(assigns(:moment))
  end
